...
export const MOCK_TRANSACTIONS: Transaction[] = [
  // Receitas
  {
    id: 't1', type: 'revenue', amount: 5000, transaction_date: '2024-07-05',
    description: 'Salário Mensal', category_id: 'c1', payment_method: 'Transferência', is_installment: false,
  },
  // Despesas à vista
  {
    id: 't2', type: 'expense', amount: 1500, transaction_date: '2024-07-10',
    description: 'Aluguel', category_id: 'c3', payment_method: 'Boleto', is_installment: false,
  },
  {
    id: 't3', type: 'expense', amount: 800, transaction_date: '2024-07-15',
    description: 'Compras do Mês', category_id: 'c4', payment_method: 'Crédito', is_installment: false,
  },
  // Despesa Parcelada
  {
   ...
   // Despesa Recorrente
  {
    id: 't7', type: 'expense', amount: 49.90, transaction_date: '2024-07-20',
    description: 'Assinatura Streaming', category_id: 'c6', payment_method: 'Crédito', is_installment: false, is_recurrent: true,
  },
] as Transaction[];
